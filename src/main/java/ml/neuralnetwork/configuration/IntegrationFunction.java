 ...
 */
public interface IntegrationFunction extends BiFunction<double[], double[], Double> {
}

enum IntegrationFunctionEnum implements IntegrationFunction {

    WEIGHTED_SUM {

        public Double apply(double[] input, double[] weights) {
